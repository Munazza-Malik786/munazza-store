...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('frontend/assets/css/flickity.min.css') }}" type="text/css">
...
<div class="humberger__menu__wrapper">
    ...
    <nav class="humberger__menu__nav mobile-menu">
        <ul>
            ...
            <li><a href="{{url('shop_grid')}}">Shop</a></li>
            <li><a href="#">Pages</a>
                <ul class="header__menu__dropdown">
                    <li><a href="{{url('shop_details')}}">Shop Details</a></li>
                    <li><a href="{{url('shoping')}}">Shoping Cart</a></li>
                    <li><a href="{{url('checkout')}}">Check Out</a></li>
                    <li><a href="{{url('blog_detail')}}">Blog Details</a></li>
                </ul>
            </li>
            <li><a href="{{url('blog')}}">Blog</a></li>
            <li><a href="{{url('contact')}}l">Contact</a></li>
        </ul>
    </nav>
        ...
        <div class="row">
            <div class="col-lg-3">
                <div class="header__logo">
                    <a href="{{ url('home') }}"><img src="{{ asset('frontend/assets/img/logo.png') }}"
                                                     alt=""></a>
                </div>
            </div>
            <div class="col-lg-6">
...
<script src="{{ asset('frontend/assets/js/flickity.min.js') }}"></script>
